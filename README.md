...
Учебный компилятор: лексер/парсер/AST/генерация кода.
...
## Установка
- Клонируйте репозиторий: git clone https://github.com/BengaminButton/xillen-compiler.git
- Перейдите в каталог: cd xillen-compiler
